...
public class UserCtl {
	...
	/*
	 * @GetMapping("/MyProfile") public String
	 * myprofile(@ModelAttribute("form")UserForm form, Model
	 * model, @RequestParam("id") long id ) throws Exception{ service.delete(id);
	 * 
	 * List<UserDTO> list = service.list(); model.addAttribute("list", list);
	 * model.addAttribute("success", "User Deleted successfully"); return
	 * "userlist"; }
	 */
